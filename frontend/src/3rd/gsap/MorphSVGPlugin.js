    ...
    ? ((s = ((e, t) => {
      ...
      (T = ((e, t) => {
        let r = t ? t.split(',') : [],
          n = {},
          o = r.length;
        for (; --o > -1; ) n[r[o]] = +e.getAttribute(r[o]) || 0;
        return n;
      })(e, d[z])),
      'rect' === z
        ? ((l = T.rx),
        ...
        : ('polyline' !== z && 'polygon' !== z) ||
          ((g = (e.getAttribute('points') + '').match(t) || []),
          (o = g.shift()),
          (i = g.shift()),
          (n = 'M' + o + ',' + i + ' L' + g.join(',')),
          'polygon' === z && (n += ',' + o + ',' + i + 'z')),
      s.setAttribute('d', _((s._gsRawPath = y(n)))),
      r &&
        e.parentNode &&
...
function u(e, t, r, n, h, p, g, c, d) {
  ...
  for (q = 0; q < E; q++)
    (M = l((h = G + q * U))),
      ...
      (L = l((h += U))),
      (F = i(h)),
      H.push(M - B * b, b + B * M, L + B * F, F - B * L, L, F);
  for (q = 0; q < H.length; q += 2)
    (M = H[q]),
      (b = H[q + 1]),
      (H[q] = M * D + b * Q + R),
      (H[q + 1] = M * W + b * Z + I);
  return (H[q - 2] = c), (H[q - 1] = d), H;
}
function y(t) {
  let n,
    o,
  ...
  if (!t || !isNaN(x[0]) || isNaN(x[1])) return console.log(S), M;
  for (n = 0; n < N; n++)
    if (
      ((_ = s),
      isNaN(x[n]) ? ((s = x[n].toUpperCase()), (h = s !== x[n])) : n--,
      (i = +x[n + 1]),
      (l = +x[n + 2]),
      h && ((i += b), (l += P)),
      n || ((g = i), (c = l)),
      ...
      p && (p.length < 8 ? (M.length -= 1) : (v += p.length)),
        (b = g = i),
        (P = c = l),
        (p = [i, l]),
        M.push(p),
      ...
      (d = b),
        (f = P),
        ('C' !== _ && 'S' !== _) ||
          ((d += b - p[p.length - 4]), (f += P - p[p.length - 3])),
        h || (b = P = 0),
        p.push(d, f, i, l, (b += 1 * x[n + 3]), (P += 1 * x[n + 4])),
        (n += 4);
    else if ('Q' === s)
      (d = b + (2 / 3) * (i - b)),
        (f = P + (2 / 3) * (l - P)),
        ...
        (b += 1 * x[n + 3]),
        (P += 1 * x[n + 4]),
        p.push(d, f, b + (2 / 3) * (i - b), P + (2 / 3) * (l - P), b, P),
        (n += 4);
    else if ('T' === s)
      (d = b - p[p.length - 4]),
        (f = P - p[p.length - 3]),
        ...
        (n += 2);
    else if ('H' === s) T(b, P, (b = i), P), (n += 1);
    else if ('V' === s) T(b, P, b, (P = i + (h ? P - b : 0))), (n += 1);
    else if ('L' === s || 'Z' === s)
      'Z' === s && ((i = g), (l = c), (p.closed = !0)),
        ('L' === s || a(b - i) > 0.5 || a(P - l) > 0.5) &&
          (T(b, P, i, l), 'L' === s && (n += 2)),
        (b = i),
        (P = l);
    else if ('A' === s) {
      if (
        ...
        for (o = 0; o < y.length; o++) p.push(y[o]);
      (b = p[p.length - 2]), (P = p[p.length - 1]);
    } else console.log(S);
  return (
    (n = p.length),
    n < 6
...
function _(e) {
  ...
  for (r = 0; r < l; r++) {
    for (
      o = e[r], i += 'M' + g(o[0]) + ',' + g(o[1]) + ' C', t = o.length, n = 2;
      n < t;
      n++
    )
      i +=
...
let m,
    ...
    for (; --m > -1; )
      for (l = e[m], r = l.length, i = 6; i < r; i += 6)
        for (
          ...
          (s = P * a),
            (h = 1 - s),
            (n = (s * s * f + 3 * h * (s * d + h * c)) * s + p),
            (o = (s * s * _ + 3 * h * (s * y + h * u)) * s + g),
            n > w ? (w = n) : n < x && (x = n),
            o > M ? (M = o) : o < b && (b = o);
    return (
      (e.centerX = (w + x) / 2),
  ...
  K = (e, t, r, n, o) => {
    ...
    if (u[0]) {
      if (
        ...
        for (w = 0; w < u.length; w++) f.splice(w, 0, $(u[w], f, w, m, p, g));
      if (d)
        for (
          d < 0 && (d = -d),
      ...
      for (w = 0; w < e.length; w++)
        (i = t[w]),
          (l = e[w]),
          (d = i.length - l.length),
          d < 0 ? J(i, (-d / 6) | 0) : d > 0 && J(l, (d / 6) | 0),
          M && !1 !== o && !l.reversed && c(l),
          (r = x[w] || 0 === x[w] ? x[w] : 'auto') &&
            (l.closed ||
            (Math.abs(l[0] - l[l.length - 2]) < 0.5 &&
              ...
              ? 'auto' === r || 'log' === r
                ? ((x[w] = r = Z(l, i, !w || !1 === o)),
                  ...
                  W(l, 6 * r))
                : 'reverse' !== r &&
                  (w && r < 0 && c(l), W(l, 6 * (r < 0 ? -r : r)))
              : !M &&
                (('auto' === r &&
                  Math.abs(i[0] - l[0]) +
                    Math.abs(i[1] - l[1]) +
                    Math.abs(i[i.length - 2] - l[l.length - 2]) +
                    Math.abs(i[i.length - 1] - l[l.length - 1]) >
                    Math.abs(i[0] - l[l.length - 2]) +
                      Math.abs(i[1] - l[l.length - 1]) +
                      Math.abs(i[i.length - 2] - l[0]) +
                      Math.abs(i[i.length - 1] - l[1])) ||
                  r % 2)
              ? (c(l), (x[w] = -1), (M = !0))
              : 'auto' === r
              ? (x[w] = 0)
              : 'reverse' === r && (x[w] = -1),
            l.closed !== i.closed && (l.closed = i.closed = !1));
      return b && V('shapeIndex:[' + x.join(',') + ']'), (e.shapeIndex = x), x;
    }
  },
  ee = (e, t, r, n, o) => {
    let i = y(e[0]),
      l = y(e[1]);
    K(i, l, t || 0 === t ? t : 'auto', r, o) &&
      ((e[0] = _(i)),
      (e[1] = _(l)),
      ('log' !== n && !0 !== n) ||
  ...
  te = (e, t) => {
    let r,
      ...
      c = p + ',' + g + ' ';
    for (
      o = e.length, r = (0.5 * t) / (0.5 * o - 1), n = 0;
      n < o - 2;
      n += 2
    ) {
      if (
        ...
        for (l = 1 / (Math.floor(h) + 1), i = 1; h > 0.999999; )
          (c +=
            (p + (a - p) * l * i).toFixed(2) +
            ',' +
            (g + (s - g) * l * i).toFixed(2) +
  ...
  se = (e) => {
    (m = P()),
      ...
      m && b
        ...
        : e && V('Please gsap.registerPlugin(MorphSVGPlugin)');
  };
const he = {
  version: '3.12.5',
  name: 'morphSVG',
  ...
  init(e, t, r, n, o) {
    ...
    let i, l, a, s, h, p, g, c, d, u, m, b, P, v, S, T, z, A, C, O, R, j;
    if (
      (N(t) && (t = t.call(r, n, e, o)),
    ...
    if (
      ...
      if (
        ...
        if (
          ((u = y(z ? t.precompile[0] : u)),
          (m = y(z ? t.precompile[1] : s)),
          !z && !K(u, m, p, g, X))
        )
          return !1;
        for (
          ('log' !== t.precompile && !0 !== t.precompile) ||
            ...
            R = 'linear' !== (t.type || he.defaultType),
            R &&
              ...
              (this._origin = u.origin =
                { x: u.left + O.x * u.width, y: u.top + O.y * u.height }),
              E[1] && (O = ie(E[1])),
              (this._eOrigin = {
              ...
              (R
                ? c[b] && d[b]
                  ? ((A = S.smoothData),
                    ...
                    (a = this._tweenRotation(S, T, b + 2)),
                    this._tweenRotation(S, T, b, a),
                    this._tweenRotation(S, T, j - 1, a),
                    (b += 4))
                  : this._tweenRotation(S, T, b)
                : ((a = this.add(S, b, S[b], T[b], 0, 0, 0, 0, 0, 1)),
                  (a =
                    this.add(S, b + 1, S[b + 1], T[b + 1], 0, 0, 0, 0, 0, 1) ||
                    a)));
      } else
        a = this.add(
          e,
  ...
  render(e, t) {
    let r,
      ...
      w = t._target,
      x = t._pt;
    for (; x; ) x.r(e, x.d), (x = x._next);
    if (1 === e && t._apply)
      for (x = t._pt; x; )
        x.end &&
          (t._prop ? (w[t._prop] = x.end) : w.setAttribute(x.endProp, x.end)),
          (x = x._next);
    else if (u) {
      for (; _; )
        (a = _.sa + e * _.ca),
          (l = _.sl + e * _.cl),
          (_.t[_.i] = t._origin.x + S(a) * l),
          (_.t[_.i + 1] = t._origin.y + T(a) * l),
          (_ = _._next);
      for (o = e < 0.5 ? 2 * e * e : (4 - 2 * e) * e - 1; y; )
        (s = y.i),
          (i = u[y.j]),
          (f = s + (s === i.length - 4 ? 7 - i.length : 5)),
          (a = v(i[f] - i[s + 1], i[f - 1] - i[s])),
          (c = T(a)),
          (d = S(a)),
          (p = i[s + 2]),
          (g = i[s + 3]),
          ...
          (i[f] = g + c * l),
          (y = y._next);
      if (((w._gsRawPath = u), t._apply)) {
        for (r = '', n = ' ', h = 0; h < u.length; h++)
          for (
            i = u[h],
              l = i.length,
              r +=
                'M' + ((i[0] * m) | 0) / m + ' ' + ((i[1] * m) | 0) / m + ' C',
              s = 2;
            s < l;
            s++
          )
            r += ((i[s] * m) | 0) / m + ' ';
        t._prop ? (w[t._prop] = r) : w.setAttribute('d', r);
      }
    }
    t._render && u && t._render.call(t._tween, u, w);
  },
  kill(e) {
